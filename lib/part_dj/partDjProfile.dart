...
class PartDjProfile extends StatefulWidget {
  var username;
  int number;
  PartDjProfile({this.username, this.number});

  @override
  _PartDjProfileState createState() => _PartDjProfileState(username, number);
}

class _PartDjProfileState extends State<PartDjProfile> {
  var username;
  int number;
  _PartDjProfileState(this.username, this.number);
