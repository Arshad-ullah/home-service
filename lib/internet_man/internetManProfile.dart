...
class InternetManProfile extends StatefulWidget {
  var username;
  int number;
  InternetManProfile({this.username, this.number});

  @override
  _InternetManProfileState createState() =>
      _InternetManProfileState(username, number);
}

class _InternetManProfileState extends State<InternetManProfile> {
  var username;
  int number;
  _InternetManProfileState(this.username, this.number);
