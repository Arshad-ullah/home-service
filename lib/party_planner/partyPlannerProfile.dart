...
class PartyPlannerProfile extends StatefulWidget {
  var username;
  int number;
  PartyPlannerProfile({this.username, this.number});

  @override
  _PartyPlannerProfileState createState() =>
      _PartyPlannerProfileState(username, number);
}

class _PartyPlannerProfileState extends State<PartyPlannerProfile> {
  var username;
  int number;
  _PartyPlannerProfileState(this.username, this.number);
