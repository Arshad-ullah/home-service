...
import 'package:homeclean/party_planner/partyPlannerProfile.dart';

class PartyPlanner extends StatefulWidget {
  @override
  _PartyPlannerState createState() => _PartyPlannerState();
}

class _PartyPlannerState extends State<PartyPlanner> {
  var value = 'PartyPlanner';
  @override
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PartyPlannerProfile(
                                          username: value,
                                          number: index,
                                        )));
                          },
