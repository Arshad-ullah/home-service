...
class DriverProfile extends StatefulWidget {
  var username;
  int number;
  DriverProfile({this.username, this.number});

  @override
  _DriverProfileState createState() => _DriverProfileState(username, number);
}

class _DriverProfileState extends State<DriverProfile> {
  var username;
  int number;
  _DriverProfileState(this.username, this.number);
