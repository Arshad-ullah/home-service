...
class PropertyMoverProfile extends StatefulWidget {
  var username;
  int number;
  PropertyMoverProfile({this.username, this.number});

  @override
  _PropertyMoverProfileState createState() =>
      _PropertyMoverProfileState(username, number);
}

class _PropertyMoverProfileState extends State<PropertyMoverProfile> {
  var username;
  int number;
  _PropertyMoverProfileState(this.username, this.number);
