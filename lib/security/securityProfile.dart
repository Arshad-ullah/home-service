...
class SecurityProfile extends StatefulWidget {
  var username;
  int number;
  SecurityProfile({this.username, this.number});

  @override
  _SecurityProfileState createState() =>
      _SecurityProfileState(username, number);
}

class _SecurityProfileState extends State<SecurityProfile> {
  var username;
  int number;
  _SecurityProfileState(this.username, this.number);
