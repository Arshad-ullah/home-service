...
class BridsMaidsProfile extends StatefulWidget {
  var username;
  int number;
  BridsMaidsProfile({this.username, this.number});

  @override
  _BridsMaidsProfileState createState() =>
      _BridsMaidsProfileState(username, number);
}

class _BridsMaidsProfileState extends State<BridsMaidsProfile> {
  var username;
  int number;
  _BridsMaidsProfileState(this.username, this.number);
