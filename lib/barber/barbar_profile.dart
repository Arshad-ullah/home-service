...
class BarbarProfile extends StatefulWidget {
  var username;
  int number;
  BarbarProfile({this.username, this.number});

  @override
  _BarbarProfileState createState() => _BarbarProfileState(username, number);
}

class _BarbarProfileState extends State<BarbarProfile> {
  var username;
  int number;
  _BarbarProfileState(this.username, this.number);
