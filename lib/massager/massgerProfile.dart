...
class MassagerProfile extends StatefulWidget {
  var username;
  int number;
  MassagerProfile({this.username, this.number});

  @override
  _MassagerProfileState createState() =>
      _MassagerProfileState(username, number);
}

class _MassagerProfileState extends State<MassagerProfile> {
  var username;
  int number;
  _MassagerProfileState(this.username, this.number);
