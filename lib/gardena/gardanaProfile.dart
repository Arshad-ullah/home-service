...
class GardanaProfile extends StatefulWidget {
  var username;
  int number;
  GardanaProfile({this.username, this.number});

  @override
  _GardanaProfileState createState() => _GardanaProfileState(username, number);
}

class _GardanaProfileState extends State<GardanaProfile> {
  var username;
  int number;
  _GardanaProfileState(this.username, this.number);
