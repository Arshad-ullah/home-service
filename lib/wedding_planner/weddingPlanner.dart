...
class WeddingPlannerProfile extends StatefulWidget {
  var username;
  int number;
  WeddingPlannerProfile({this.username, this.number});

  @override
  _WeddingPlannerProfileState createState() =>
      _WeddingPlannerProfileState(username, number);
}

class _WeddingPlannerProfileState extends State<WeddingPlannerProfile> {
  var username;
  int number;
  _WeddingPlannerProfileState(this.username, this.number);
