...
class HouseBoyProfile extends StatefulWidget {
  var username;
  int number;
  HouseBoyProfile({this.username, this.number});

  @override
  _HouseBoyProfileState createState() =>
      _HouseBoyProfileState(username, number);
}

class _HouseBoyProfileState extends State<HouseBoyProfile> {
  var username;
  int number;
  _HouseBoyProfileState(this.username, this.number);
