...
class PrivateSecurityProfile extends StatefulWidget {
  var username;
  int number;
  PrivateSecurityProfile({this.username, this.number});

  @override
  _PrivateSecurityProfileState createState() =>
      _PrivateSecurityProfileState(username, number);
}

class _PrivateSecurityProfileState extends State<PrivateSecurityProfile> {
  var username;
  int number;
  _PrivateSecurityProfileState(this.username, this.number);
