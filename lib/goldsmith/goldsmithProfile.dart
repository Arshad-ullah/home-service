...
class GoldsmithProfile extends StatefulWidget {
  var username;
  int number;
  GoldsmithProfile({this.username, this.number});

  @override
  _GoldsmithProfileState createState() =>
      _GoldsmithProfileState(username, number);
}

class _GoldsmithProfileState extends State<GoldsmithProfile> {
  var username;
  int number;
  _GoldsmithProfileState(this.username, this.number);
