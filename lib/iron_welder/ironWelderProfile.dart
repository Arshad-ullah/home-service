...
class IronWelderProfile extends StatefulWidget {
  var username;
  int number;
  IronWelderProfile({this.username, this.number});

  @override
  _IronWelderProfileState createState() =>
      _IronWelderProfileState(username, number);
}

class _IronWelderProfileState extends State<IronWelderProfile> {
  var username;
  int number;
  _IronWelderProfileState(this.username, this.number);
