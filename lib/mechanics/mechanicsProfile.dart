...
class MechanicsProfile extends StatefulWidget {
  var username;
  int number;
  MechanicsProfile({this.username, this.number});

  @override
  _MechanicsProfileState createState() =>
      _MechanicsProfileState(username, number);
}

class _MechanicsProfileState extends State<MechanicsProfile> {
  var username;
  int number;
  _MechanicsProfileState(this.username, this.number);
