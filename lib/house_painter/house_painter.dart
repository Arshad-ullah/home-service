...
import 'package:homeclean/house_painter/housePainterProfile.dart';

class HousePainter extends StatefulWidget {
  @override
  _HousePainterState createState() => _HousePainterState();
}

class _HousePainterState extends State<HousePainter> {
  var value = 'HousePainter';
  @override
                        ...
                        ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => HousePainterProfile(
                                            username: value,
                                            number: index,
                                          )));
                            }),
