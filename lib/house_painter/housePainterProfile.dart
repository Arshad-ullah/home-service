...
class HousePainterProfile extends StatefulWidget {
  var username;
  int number;
  HousePainterProfile({this.username, this.number});

  @override
  _HousePainterProfileState createState() =>
      _HousePainterProfileState(username, number);
}

class _HousePainterProfileState extends State<HousePainterProfile> {
  var username;
  int number;
  _HousePainterProfileState(this.username, this.number);
