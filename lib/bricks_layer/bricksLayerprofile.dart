...
class BricksLayerProfile extends StatefulWidget {
  var username;
  int number;
  BricksLayerProfile({this.username, this.number});

  @override
  _BricksLayerProfileState createState() =>
      _BricksLayerProfileState(username, number);
}

class _BricksLayerProfileState extends State<BricksLayerProfile> {
  var username;
  int number;
  _BricksLayerProfileState(this.username, this.number);
