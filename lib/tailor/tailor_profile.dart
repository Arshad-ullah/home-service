...
class TailorProfile extends StatefulWidget {
  var username;
  int number;
  TailorProfile({this.username, this.number});

  @override
  _TailorProfileState createState() => _TailorProfileState(username, number);
}

class _TailorProfileState extends State<TailorProfile> {
  var username;
  int number;
  _TailorProfileState(this.username, this.number);
