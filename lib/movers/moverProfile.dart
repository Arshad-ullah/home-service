...
class MoverProfile extends StatefulWidget {
  var username;
  int number;
  MoverProfile({this.username, this.number});

  @override
  _MoverProfileState createState() => _MoverProfileState(username, number);
}

class _MoverProfileState extends State<MoverProfile> {
  var username;
  int number;
  _MoverProfileState(this.username, this.number);
