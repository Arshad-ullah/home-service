...
class HouseHelperProfile extends StatefulWidget {
  var username;
  int number;
  HouseHelperProfile({this.username, this.number});

  @override
  _HouseHelperProfileState createState() =>
      _HouseHelperProfileState(username, number);
}

class _HouseHelperProfileState extends State<HouseHelperProfile> {
  var username;
  int number;
  _HouseHelperProfileState(this.username, this.number);
