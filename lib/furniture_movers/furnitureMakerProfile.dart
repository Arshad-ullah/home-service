...
class FurnitureMakerProfile extends StatefulWidget {
  var username;
  int number;
  FurnitureMakerProfile({this.username, this.number});

  @override
  _FurnitureMakerProfileState createState() =>
      _FurnitureMakerProfileState(username, number);
}

class _FurnitureMakerProfileState extends State<FurnitureMakerProfile> {
  var username;
  int number;
  _FurnitureMakerProfileState(this.username, this.number);
